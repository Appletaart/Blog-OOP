...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h2>USERS</h2>
            <td><a href="add_user.php" class="btn btn-primary rounded"><i class="fas fa-user-plus"></i>Add user</a></td>
            <table class="table table-header">
                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        <td><?php echo $user->id; ?></td> <!--แก้จาก photo_id-->
                        ...
                        <td><a href="edit_user.php?id=<?php echo $user->id; ?>"
                               class="btn btn-danger rounded-0"><i class="fas fa-edit"></i></a></td><!--แก้จาก photo_id-->
